...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    providePrimeNG({
      ...
      license: 'eyJpZCI6IjUzNWQ0MWU1LWE0MzYtNGIyZC04ODRjLWRlNmEwNDVmODI1NSIsInByb2R1Y3QiOiJwcmltZXVpIiwidGllciI6ImNvbW11bml0eSIsInR5cGUiOiJkZXYiLCJpYXQiOjE3ODg4NDcwOTAsImV4cCI6MTgyMDM4MzA5MH0.G3Gcacpx1mtRVUHVDUMwYsqFnuMYxc_ArYgQ5CuUHN2OC0QM9-dlupckn7jmDgPCcL91i3Qo9LsRHlNDskfOCg',
      theme: {
        preset: Aura,
        options: {
